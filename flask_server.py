...
def get_order_history(session, account_name, symbol='BTCUSDT', limit=1000):
    try:
...
def get_trade_history(session, account_name, symbol='BTCUSDT', limit=1000):
    try:
...
def get_closed_pnl(session, account_name, symbol='BTCUSDT', limit=1000):
    try:
